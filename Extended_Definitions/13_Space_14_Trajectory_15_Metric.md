...
* simplifying the description of trajectories.
...
### Validation Status:
- [x] Node Identities: 13. Space, 14. Trajectory, 15. Metric
- [x] System Identity: Backticks Applied
- [x] Non-Substantiality of Space Verified
- [x] Metric as Computational Tool Confirmed
