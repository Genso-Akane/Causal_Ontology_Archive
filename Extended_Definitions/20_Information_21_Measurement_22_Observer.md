...
* measurement is realized as a change of subsystem states,
* information is fixed in the structure of subsequent processes.

**In technical systems:**
* measurement is realized as a change of register parameters,
...
### Causal Positioning:
`2. Event` → `20. Information`  
(`20. Information` + `7. System`) → `21. Measurement` → `22. Observer`

### Validation Status:
- [x] Node Identities: 20. Information, 21. Measurement, 22. Observer
- [x] System Identity: Backticks Applied
- [x] Information-Event Traceability Verified
- [x] Physicalist Measurement Definition Confirmed
