...
* this difference determines the change of `14. Trajectory`.
...
* is a consequence of the structure of processes.

**Consequence:**
* motion of bodies is a secondary effect,
* primary is the modification of `11. Tempo of Processes`.
...
* `15. Metric` fixes the consequence of the modification of dynamics.

---

### Causal Positioning:
(`3. Energy` + `11. Tempo of Processes`) → `18. Gravitation` → `19. Gravitational Influence`

### Validation Status:
- [x] Node Identities: 18. Gravitation, 19. Gravitational Influence
- [x] System Identity: Backticks Applied
- [x] Tempo Inhomogeneity Logic Verified
- [x] Metric/Cause Distinction Confirmed
